...
public class Notifications extends ParseObject {
  ...
  public void setPostImage(ParseFile image){
    put(COL_MEDIA_IMAGE, image);
  }
  ...
  public String getPostImageUrl(){
    String  postImageUrl = "";
    if(this.getParseFile(COL_MEDIA_IMAGE) != null){
      postImageUrl = this.getParseFile(COL_MEDIA_IMAGE).getUrl();
    }
    return postImageUrl;
  }
